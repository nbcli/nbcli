...
def get_common_parser():
    ...
    common_parser.add_argument(
        "-v", "--verbose", action="count", help="Show more logging messages"
    )

    common_parser.add_argument(
        "-q", "--quiet", action="count", help="Show fewer logging messages"
    )
...
def get_view_parser():
    ...
    view_parser.add_argument(
        "--cols", nargs="*", help="Custom columns for table output."
    )
